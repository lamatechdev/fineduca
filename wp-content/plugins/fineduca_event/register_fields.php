...
add_action( 'woocommerce_register_form_start', 'register_show_extra_fields_event' );

/**
 * Add new register fields for WooCommerce registration.
 */
function register_show_extra_fields_event() {   
    wp_enqueue_script('jquery');
    wp_enqueue_script('jquery.maskedinput.min');
    wp_enqueue_script('script_register');

    $mae = get_post_ancestors(get_the_ID());
    if(count($mae)>0 && get_the_title($mae[0])=="Encontro FINEDUCA"){
?>
<style type="text/css">  
...
#tabela_valores  tbody tr:nth-child(even) {background-color: #CACDDC}
    ...
    <li><strong>Os associados com anuidade paga recebem desconto na inscrição do V Encontro Fineduca.</strong><br />
    ...
    <li><p><strong>Deseja associar-se à Fineduca?</strong> <input type='checkbox' name='add_anuidade' value='Sim' /></p></li></ul>
    <div class='clear'></div>
